namespace PhotoShare.Data.Migrations
{
    ...
    internal class Configuration : DbMigrationsConfiguration<PhotoShareContext>
    {
        ...
        protected override void Seed(PhotoShareContext context)
        {
            ...
            //unit.Towns.Add(vn);
            //unit.Towns.Add(tr);
            //User pesho = new User() { Username = "pesho", Password = "KKkk??pmer00", Email = "pesho@peshov.bg", Age = 20, RegisteredOn = DateTime.Now, LastTimeLoggedIn = DateTime.Now, BornTown = bs, CurrentTown = vn, IsDeleted = false, };
            ...
            //unit.Users.Add(new User() { Username = "minka", Password = "Lpkkasdrjj", Email = "pesho@peshov.bg", Age = 20, RegisteredOn = DateTime.Now, LastTimeLoggedIn = DateTime.Now, BornTown = bs, CurrentTown = vn, IsDeleted = false, });
            //////TODO seed albums
